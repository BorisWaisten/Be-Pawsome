...
function PerfilPublicacion({ publicacion }) {
  ...
  return (
    <>
      <div className="bg-white rounded-lg shadow-lg p-6 my-5 w-full h-full flex flex-col md:flex-row">
        {/* Columna de la imagen */}
        <div className="slider-container relative flex-grow">
          {/* Flecha izquierda */}
          <span
        ...
        {/* Columna de detalles */}
        <div className="mb-4 bg-white rounded-lg shadow-lg p-4 flex-grow">

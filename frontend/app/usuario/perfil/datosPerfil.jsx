...
export default function Usuario() {
	...
	const handleConfirmarEliminacion = async () => {
		try {
			...
			await axios.delete(`http://localhost:5000/publicacion/usuario/${usuario._id}`);
	...
	return (
		<main>
			...
			<button onClick={handleEliminarUsuarioClick} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mt-4">
				Eliminar Usuario
			</button>
			{confirmarEliminacion && (
        <div className="modal">
          <p>¿Estás seguro de que deseas eliminar este usuario y todas sus publicaciones?</p>
